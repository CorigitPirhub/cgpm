...
`run_benchmark.py -> run_egf_3d_tum.py -> egf_dhmap3d/P10_method/geometry_chain.py`.
...
UPSTREAM_ROOT = PROJECT_ROOT / "output" / "post_cleanup" / "s2_stage" / "104_depth_bias_minus1cm"
DOWNSTREAM_ROOT = PROJECT_ROOT / "output" / "post_cleanup" / "s2_stage" / "99_manhattan_plane_completion"
ANCHOR_ROOT = PROJECT_ROOT / "output" / "post_cleanup" / "s2_stage" / "97_global_map_anchoring"
...
UPSTREAM_COMPARE = PROJECT_ROOT / "processes" / "s2" / "S2_RPS_UPSTREAM_GEOMETRY_COMPARE.csv"
...
def main() -> None:
    ...
    variants = [
        ("108_geometry_chain_coupled_direct", PROJECT_ROOT / "output" / "post_cleanup" / "s2_stage" / "108_geometry_chain_coupled_direct"),
        ("109_geometry_chain_coupled_projected", PROJECT_ROOT / "output" / "post_cleanup" / "s2_stage" / "109_geometry_chain_coupled_projected"),
        ("110_geometry_chain_coupled_conservative", PROJECT_ROOT / "output" / "post_cleanup" / "s2_stage" / "110_geometry_chain_coupled_conservative"),
    ]
