...
CONTROL_ROOT = PROJECT_ROOT / 'output' / 'post_cleanup' / 's2_stage' / '80_ray_penetration_topology_control'
...
TUM_COMPARE = PROJECT_ROOT / 'processes' / 's2' / 'S2_RPS_TOPOLOGY_CONSTRAINT_COMPARE.csv'
BONN_ALL3 = [
    'rgbd_bonn_balloon2',
    'rgbd_bonn_balloon',
    'rgbd_bonn_crowd2',
...
def main() -> None:
    ...
    variants = [
        ...
        ('86_rear_plane_clustering_snapping', PROJECT_ROOT / 'output' / 'post_cleanup' / 's2_stage' / '86_rear_plane_clustering_snapping'),
        ('87_front_mask_guided_back_projection', PROJECT_ROOT / 'output' / 'post_cleanup' / 's2_stage' / '87_front_mask_guided_back_projection'),
        ('88_occlusion_depth_hypothesis_validation', PROJECT_ROOT / 'output' / 'post_cleanup' / 's2_stage' / '88_occlusion_depth_hypothesis_validation'),
    ]
