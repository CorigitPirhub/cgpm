...
def _runner_repro_cmd(method: str, sequence: str) -> str:
    ...
    if method == "neural_implicit":
        return (
            "python scripts/run_p3_real_external.py "
...
def main() -> None:
    ...
    ap.add_argument(
        "--out_root",
        type=str,
        default="output/post_cleanup/p12_external_native_final",
    )
    ap.add_argument(
        "--sequences",
        type=str,
    ...
    ap.add_argument(
        "--out_health_md",
        type=str,
        default="output/post_cleanup/external_audit/BASELINE_HEALTHCHECK.md",
    )
    ap.add_argument(
        "--out_health_csv",
        type=str,
