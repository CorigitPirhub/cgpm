...
CONTROL_ROOT = PROJECT_ROOT / "output" / "post_cleanup" / "s2_stage" / "93_spatial_neighborhood_density_clustering"
HSSA_COMPARE = PROJECT_ROOT / "processes" / "s2" / "S2_RPS_HSSA_COMPARE.csv"
...
def main() -> None:
    ...
    variants = [
        ...
        ("95_geodesic_balloon_consistency", PROJECT_ROOT / "output" / "post_cleanup" / "s2_stage" / "95_geodesic_balloon_consistency"),
        ("96_support_cluster_model_fitting", PROJECT_ROOT / "output" / "post_cleanup" / "s2_stage" / "96_support_cluster_model_fitting"),
        ("97_global_map_anchoring", PROJECT_ROOT / "output" / "post_cleanup" / "s2_stage" / "97_global_map_anchoring"),
    ]
