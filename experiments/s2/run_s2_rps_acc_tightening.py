...
CONTROL_ROOT = PROJECT_ROOT / "output" / "s2_stage" / "99_manhattan_plane_completion"
...
def main() -> None:
    ...
    variants = [
        ...
        ("101_manhattan_plane_projection_hard_snapping", PROJECT_ROOT / "output" / "s2_stage" / "101_manhattan_plane_projection_hard_snapping"),
        ("102_scale_drift_correction", PROJECT_ROOT / "output" / "s2_stage" / "102_scale_drift_correction"),
        ("103_local_cluster_refinement", PROJECT_ROOT / "output" / "s2_stage" / "103_local_cluster_refinement"),
    ]
