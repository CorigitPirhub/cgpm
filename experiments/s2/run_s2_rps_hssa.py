...
CONTROL_ROOT = PROJECT_ROOT / "output" / "s2_stage" / "80_ray_penetration_consistency"
RAY_COMPARE = PROJECT_ROOT / "output" / "s2" / "S2_RPS_RAY_CONSISTENCY_COMPARE.csv"
...
def main() -> None:
    ...
    variants = [
        ...
        ("92_multi_view_ray_support_aggregation", PROJECT_ROOT / "output" / "s2_stage" / "92_multi_view_ray_support_aggregation"),
        ("93_spatial_neighborhood_density_clustering", PROJECT_ROOT / "output" / "s2_stage" / "93_spatial_neighborhood_density_clustering"),
        ("94_historical_tsdf_consistency_reactivation", PROJECT_ROOT / "output" / "s2_stage" / "94_historical_tsdf_consistency_reactivation"),
    ]
