...
def main() -> None:
    ...
    variants = [
        ...
        ('89_front_back_surface_pairing_guard', PROJECT_ROOT / 'output' / 's2_stage' / '89_front_back_surface_pairing_guard'),
        ('90_background_plane_evidence_accumulation', PROJECT_ROOT / 'output' / 's2_stage' / '90_background_plane_evidence_accumulation'),
        ('91_occlusion_depth_hypothesis_tb_protection', PROJECT_ROOT / 'output' / 's2_stage' / '91_occlusion_depth_hypothesis_tb_protection'),
    ]
