...
CONTROL_ROOT = PROJECT_ROOT / "output" / "s2_stage" / "97_global_map_anchoring"
DONOR_ROOT = PROJECT_ROOT / "output" / "s2_stage" / "93_spatial_neighborhood_density_clustering"
...
def main() -> None:
    ...
    variants = [
        ...
        ("98_geodesic_support_diffusion", PROJECT_ROOT / "output" / "s2_stage" / "98_geodesic_support_diffusion"),
        ("99_manhattan_plane_completion", PROJECT_ROOT / "output" / "s2_stage" / "99_manhattan_plane_completion"),
        ("100_cluster_view_inpainting", PROJECT_ROOT / "output" / "s2_stage" / "100_cluster_view_inpainting"),
    ]
