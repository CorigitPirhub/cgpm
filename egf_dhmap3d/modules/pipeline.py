...
class EGFDHMap3D:
    ...
    def _refine_pose_with_map(
        ...
        map_pts, _ = self.voxel_map.extract_surface_points(
            ...
            snef_dscore_margin=float(self.cfg.surface.snef_dscore_margin),
            snef_free_ratio_quantile=float(self.cfg.surface.snef_free_ratio_quantile),
            snef_free_ratio_margin=float(self.cfg.surface.snef_free_ratio_margin),
            snef_abs_phi_quantile=float(self.cfg.surface.snef_abs_phi_quantile),
            snef_abs_phi_margin=float(self.cfg.surface.snef_abs_phi_margin),
            snef_min_keep_per_block=int(self.cfg.surface.snef_min_keep_per_block),
            snef_min_keep_ratio_per_block=float(self.cfg.surface.snef_min_keep_ratio_per_block),
            snef_min_candidates_per_block=int(self.cfg.surface.snef_min_candidates_per_block),
            snef_anchor_rho_quantile=float(self.cfg.surface.snef_anchor_rho_quantile),
            snef_anchor_dscore_quantile=float(self.cfg.surface.snef_anchor_dscore_quantile),
            snef_anchor_min_per_block=int(self.cfg.surface.snef_anchor_min_per_block),
            two_stage_enable=bool(self.cfg.surface.two_stage_enable),
            two_stage_geom_margin=float(self.cfg.surface.two_stage_geom_margin),
            two_stage_dynamic_dscore_quantile=float(self.cfg.surface.two_stage_dynamic_dscore_quantile),
            two_stage_dynamic_free_quantile=float(self.cfg.surface.two_stage_dynamic_free_quantile),
            two_stage_dynamic_rho_quantile=float(self.cfg.surface.two_stage_dynamic_rho_quantile),
            two_stage_dynamic_rho_margin=float(self.cfg.surface.two_stage_dynamic_rho_margin),
            two_stage_dynamic_require_low_rho=bool(self.cfg.surface.two_stage_dynamic_require_low_rho),
            adaptive_enable=bool(self.cfg.surface.adaptive_enable),
            adaptive_rho_ref=float(self.cfg.surface.adaptive_rho_ref),
            adaptive_phi_min_scale=float(self.cfg.surface.adaptive_phi_min_scale),
